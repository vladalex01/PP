...
(define (num->base n b)
  (if (eq? n 0) '()  (append (num->base (quotient n b) b) (list(modulo n b)))))
...
;(and (palindrome?(num->base start 10 )) (palindrome?(num->base start 4 )))
(define (first-b-pal start b)
  (if (and (palindrome?(num->base start 10 )) (palindrome?(num->base start 9 )) (palindrome?(num->base start 8 )) (palindrome?(num->base start 4 )) ) 
      ;(if (and (palindrome?(num->base start 8 )) (palindrome?(num->base start 5 )))
      start
